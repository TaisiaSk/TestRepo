...
void bondingStrings(char str1[],char str2[],char* str3,const size_t len){
    size_t len1 = 0;
    while (str1[len1] != '\0'&&len>len1) {
        str3[len1] = str1[len1];
        len1++;
    }
    size_t len2 = 0;
    while (str2[len2] != '\0'&&len>len2) {
...
int main() {
    ...
    bondingStrings(str1, str2, str3,len);
    std::cout << str3 << '\n';
